...
<div id="contactInfo">
    ...
    <a href="https://www.linkedin.com/in/eva-lugo/" target="_blank">linkedin.com/in/eva-lugo</a> |
    (203)-343-2688
</div>
...
<div class="section">
    ...
    <div class="subsection">
        <div>
            <strong>Alianza Latina</strong>, Troy, NY
            <span class="dates">Sep. 2024 – Present</span>
        </div>
        <ul>
            <li><em>Multimedia Chair</em></li>
            <li class="bullet indented">
                Promote cultural awareness, celebrate Latin heritage, and support students from diverse backgrounds
            </li>
        </ul>
    </div>
    ...
    <div class="subsection">
        <div>
            <strong>Association of Computing Machinery Women’s Chapter</strong>, Troy, NY
            <span class="dates">Sep. 2024 – Present</span>
        </div>
        <ul>
            <li><em>Member</em></li>
            <li class="bullet indented">
                Foster gender diversity in tech, organized professional development events, and fostered a supportive community for women in computing through networking and mentorship opportunities
            </li>
        </ul>
    </div>
    ...
    <div class="subsection">
        <div>
            <strong>Women at Rensselaer Mentor Program</strong>, Troy, NY
            <span class="dates">Sep. 2024 – Present</span>
        </div>
        <ul>
            <li><em>Mentee</em></li>
            <li class="bullet indented">
                Support female students through mentorship, facilitate networking opportunities, and encourage personal and professional growth within the RPI community
            </li>
        </ul>
    </div>
    ...
    <div class="subsection">
        <div>
            <strong>Daniel Hand Indoor and Outdoor Girls Track Team</strong>, Madison, CT
            <span class="dates">Aug. 2023 – Jun. 2024</span>
        </div>
        <ul>
            <li><em>Team Captain</em></li>
            <li class="bullet indented">
                Cultivated supportive team environment, focused on empowering athletes, and modeled good sportsmanship
            </li>
        </ul>
    </div>
    ...
    <div class="subsection">
        <div>
            <strong>Handmade Makers Club</strong>, Madison, CT
            <span class="dates">Sep. 2023 – Jun. 2024</span>
        </div>
        <ul>
            <li><em>President</em></li>
            <li class="bullet indented">
                Promoted innovation, led workshops, managed makerspace, and fostered collaborative environment for makers
            </li>
        </ul>
    </div>
    ...
    <div class="subsection">
        <div>
            <strong>Diversity Club</strong>, Madison, CT
            <span class="dates">Aug. 2024 – Jun. 2024</span>
        </div>
        <ul>
            <li><em>President</em></li>
    ...
    <div class="subsection">
        <div>
            <strong>National Honors Society Daniel Hand Chapter</strong>, Madison, CT
            <span class="dates">Sep. 2022 – Jun. 2024</span>
        </div>
        <ul>
            <li><em>Member</em></li>
            <li class="bullet indented">Recognized for academic achievement, leadership, service, and character</li>
        </ul>
    </div>
</div>
...
<div class="section">
    ...
    <ul>
        ...
        <li class="bullet indented">Time management, Communication, Marketing, Interpersonal Skills, Adaptability, Problem-Solving</li>
    </ul>
</div>

<?php
// keep your shared login modal + footer
