...
<div class="center">
  ...
  <div class="header">
    <nav>
      ...
      <a href="aboutme.html"><i class="fa-solid fa-user"></i> About</a>
      <a href="resume.html"><i class="fa-solid fa-file"></i> Resume</a>
      <a href="labs.html"><i class="fa-solid fa-folder"></i> Labs</a>
  ...
  <div class="section">
    ...
    <div class="subsection">
      <div><strong>Rensselaer Polytechnic Institute</strong>, Troy, NY <span class="dates">Expected Graduation Year: May 2028</span></div>
      <div>Bachelor of Science: Computer Science and Information Technology and Web Sciences</div>
      <div><em>Awards:</em> Rensselaer Leadership Award, Women's Leadership Award, Rensselaer Recognition Award</div>
    </div>
    <div class="subsection">
      <div><strong>Daniel Hand High School</strong>, Madison, CT <span class="dates">Graduation Date: June 2024</span></div>
      <div><em>Awards:</em> The Connecticut State Seal of Biliteracy, The Reverence Franklin A. Bower Madison Rotary Foundation Scholarship</div>
      <div>GPA: 3.8</div>
    </div>
  </div>
  <div class="section">
    ...
    <div class="subsection">
      <div><strong>Self-Employed Care and Household Provider</strong>, Madison, CT <span class="dates">Jan. 2021 – Present</span></div>
      <ul>
  ...
  <div class="section">
    ...
    <div class="subsection">
      <div><strong>Society of Hispanic Professional Engineers RPI Chapter</strong>, Troy, NY <span class="dates">Sep. 2024 – Present</span></div>
      <ul>
        <li><em>Fundraising Committee Member</em></li>
        <li class="bullet indented">Collaborate with members to develop and execute fundraising initiatives and increase community engagement</li>
        <li><em>Member</em></li>
