...
$(document).ready(function () {
  ...
  $('h1').click(function() {
    $('.myName').text('Eva Lugo');
    $('.myName').addClass('styled-name');
  });
  ...
  $('#labList').off('click', 'li').on('click', 'li', function() {
  ...
  $('#AddListItem').click(function() {
    const itemCount = $('#labList li').length;
    $('#labList').append(`<li>List item ${itemCount + 1}</li>`);
  });
